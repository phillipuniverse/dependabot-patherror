...
class MaxSpeedOneOf(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """MaxSpeedOneOf - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): if omitted defaults to "unlimited", must be one of ["unlimited", ]  # noqa: E501

        Keyword Args:
            value (str): if omitted defaults to "unlimited", must be one of ["unlimited", ]  # noqa: E501
