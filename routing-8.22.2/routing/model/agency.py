...
class Agency(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'id': (str,),  # noqa: E501
            'name': (str,),  # noqa: E501
            'website': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
    ...
    def _from_openapi_data(cls, id, name, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            website (bool, date, datetime, dict, float, int, list, str, none_type): Link to the agency's website.. [optional]  # noqa: E501
            icon (bool, date, datetime, dict, float, int, list, str, none_type): Agency icon url. [optional]  # noqa: E501
        """
