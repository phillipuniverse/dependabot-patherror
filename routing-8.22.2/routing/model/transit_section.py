...
class TransitSection(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, type, departure, arrival, *args, **kwargs):  # noqa: E501
        """TransitSection - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, type, departure, arrival, *args, **kwargs):  # noqa: E501
        """TransitSection - a model defined in OpenAPI
