...
def lazy_import():
    ...
    globals()['DeboardAction'] = DeboardAction


class TransitPostAction(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'DeboardAction': DeboardAction,
            'deboard': DeboardAction,
        }
        if not val:
            return None
        return {'action': val}
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """TransitPostAction - a model defined in OpenAPI
