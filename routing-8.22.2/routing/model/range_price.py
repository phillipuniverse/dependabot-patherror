...
class RangePrice(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, currency, *args, **kwargs):  # noqa: E501
        """RangePrice - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, currency, *args, **kwargs):  # noqa: E501
        """RangePrice - a model defined in OpenAPI
