...
class PedestrianSpeed(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """PedestrianSpeed - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (float): Pedestrian speed in meters per second. if omitted defaults to 1  # noqa: E501

        Keyword Args:
            value (float): Pedestrian speed in meters per second. if omitted defaults to 1  # noqa: E501
