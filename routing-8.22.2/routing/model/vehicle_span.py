...
class VehicleSpan(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'routing_zones': ([int],),  # noqa: E501
            'notices': ([int],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """VehicleSpan - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            car_attributes ([str]): Car specific `AccessAttributes`.  `AccessAttributes` is applied to a span of a route section and describes access flags of a street. * `open`:  This part of the route is open to cars. * `noThrough`:  This part of the route can only be entered if the destination is located there. * `tollRoad`: This part of the route is restricted with a fee (or toll).  As it is possible that new access attributes are supported in the future, unknown access attributes should be ignored. . [optional]  # noqa: E501
            ...
            incidents ([int]): A list of indices into the incident array of the parent section. References all incidents that apply to the span. This requires `incidents` to be specified as part of the `return` parameter. . [optional]  # noqa: E501
            routing_zones ([int]): A list of indices into the routing zone array of the parent section. References all applicable routing zones to the span. . [optional]  # noqa: E501
            notices ([int]): A list of indices into the notices array of the parent section. References all notices that apply to the span. . [optional]  # noqa: E501
        """
