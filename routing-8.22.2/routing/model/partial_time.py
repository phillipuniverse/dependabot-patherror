...
class PartialTime(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """PartialTime - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): **RFC 3339**, section 5.6 as defined by `partial-time`..  # noqa: E501

        Keyword Args:
            value (str): **RFC 3339**, section 5.6 as defined by `partial-time`..  # noqa: E501
