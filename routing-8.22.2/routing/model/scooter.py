...
class Scooter(ModelNormal):
    ...
    attribute_map = {
        'allow_highway': 'allowHighway',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """Scooter - a model defined in OpenAPI
