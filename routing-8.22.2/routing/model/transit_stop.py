...
class TransitStop(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, departure, *args, **kwargs):  # noqa: E501
        """TransitStop - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            duration (int): Stop duration. If not set the vehicle departs as soon as people are on board.. [optional] if omitted the server will use the default value of 0  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, departure, *args, **kwargs):  # noqa: E501
        """TransitStop - a model defined in OpenAPI
