...
class MatchTrace(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'trace': ([MatchTracePoint],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, trace, *args, **kwargs):  # noqa: E501
        """MatchTrace - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, trace, *args, **kwargs):  # noqa: E501
        """MatchTrace - a model defined in OpenAPI
