...
class MapView(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, west, south, east, north, *args, **kwargs):  # noqa: E501
        """MapView - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, west, south, east, north, *args, **kwargs):  # noqa: E501
        """MapView - a model defined in OpenAPI
