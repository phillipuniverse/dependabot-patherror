...
class ErrorResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, status, title, correlation_id, request_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            cause (str): Human-readable explanation for the error. [optional]  # noqa: E501
            action (str): Human-readable action for the user. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, status, title, correlation_id, request_id, *args, **kwargs):  # noqa: E501
        """ErrorResponse - a model defined in OpenAPI
