...
class MatchInfo(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, start, end, value, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            qq (str): The matched qualified query field type. If this is not returned, then matched value refers to the freetext query. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, start, end, value, *args, **kwargs):  # noqa: E501
        """MatchInfo - a model defined in OpenAPI
