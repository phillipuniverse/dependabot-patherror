...
class QueryTermResultItem(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, term, replaces, start, end, *args, **kwargs):  # noqa: E501
        """QueryTermResultItem - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, term, replaces, start, end, *args, **kwargs):  # noqa: E501
        """QueryTermResultItem - a model defined in OpenAPI
